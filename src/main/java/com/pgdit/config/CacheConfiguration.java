...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.pgdit.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(com.pgdit.domain.Authority.class.getName(), jcacheConfiguration);
